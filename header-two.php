...
<header>
    <nav class="navbar-custom navbar navbar-expand-lg fixed-top">
        <div class="container">
            <a class="navbar-brand" href="<?php echo $config['base_url']; ?>#home">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul id="nav-custom" class="navbar-nav ms-auto mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link nav-link-custom" href="<?php echo $config['base_url']; ?>#why-us">Why us</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-custom" href="<?php echo $config['base_url']; ?>#exp">Experiences</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-custom" href="<?php echo $config['base_url']; ?>#how-it-work">How it works</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-custom" href="<?php echo $config['base_url']; ?>#pricing">Pricing</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link nav-link-custom" href="<?php echo $config['base_url']; ?>#faq">F.A.Q</a>
                    </li>
